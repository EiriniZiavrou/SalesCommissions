...
public class StatsDisplayWindow extends JDialog {
	...
	private StatsFilterWindow selectionWindow;
	...
	public StatsDisplayWindow(final StatsFilterWindow sw, ReceiptManager agent,double tSales,int tItems,
	...
	private void initialise(){
		...
		resultWindowPanel.setLayout(null);
		{
			...
			htmlReportButton.setBounds(436, 232, 163, 84);
		...
		}
		{
			...
			xmlReportButton.setBounds(436, 132, 163, 84);
	...
	private void outputTXTButtonPressed(ActionEvent evt) {
		...
		TXTFileChooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
		TXTFileChooser.showSaveDialog(null);
		File receiptFileTXT = TXTFileChooser.getSelectedFile();
		TXTReporter makeTXTFile = new TXTReporter(selectedAgent, receiptFileTXT.getAbsolutePath());
		makeTXTFile.saveFile();
		//JOptionPane.showMessageDialog(null,"� ������� ������������ ��������");
		JOptionPane.showMessageDialog(null, "Reported to TXT");
	}
	private void outputXMLButtonPressed(ActionEvent evt) {
		...
		TXTFileChooser.showSaveDialog(null);
		File receiptFileTXT = TXTFileChooser.getSelectedFile();
		XMLReporter makeXMLFile = new XMLReporter(selectedAgent, receiptFileTXT.getAbsolutePath());
		makeXMLFile.saveFile();
		//JOptionPane.showMessageDialog(null,"� ������� ������������ ��������");	
		JOptionPane.showMessageDialog(null, "Could not report to XML");	
	}
	private void outputHTMLButtonPressed(ActionEvent evt) {
		JFileChooser HTMLFileChooser;
		HTMLFileChooser = new JFileChooser();     
		HTMLFileChooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
		HTMLFileChooser.showSaveDialog(null);
		File receiptFileHTML = HTMLFileChooser.getSelectedFile();
		HTMLReporter makeHTMLFile = new HTMLReporter(selectedAgent, receiptFileHTML.getAbsolutePath());
		makeHTMLFile.saveFile();
		//JOptionPane.showMessageDialog(null,"� ������� ������������ ��������");	
		JOptionPane.showMessageDialog(null, "Reported to HTML");	
	}
